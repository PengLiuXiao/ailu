...
describe('testProviderConnection', () => {
  test('rejects plaintext remote endpoints before sending credentials', async () => {
    await expect(testProviderConnection({
      agentId: 'codex',
  ...
  test('allows keyless loopback HTTP providers', async () => {
  ...
  ])('rejects credential-bearing provider URL %s', async (baseUrl) => {
    await expect(testProviderConnection({
      agentId: 'codex',
      baseUrl,
      apiKey: 'secret',
